...
// Reward yang diberikan saat level ini pertama kali achieved & diklaim user.
const LevelRewardSchema = new mongoose.Schema(
  {
    benefitType: { type: String, enum: BENEFIT_TYPE_VALUES, required: true },
...
const UserLevelSchema = new mongoose.Schema({
  ...
  // Reward yang di-grant ke UserLevelAchievement saat level ini achieved (opsional)
  rewards: {
